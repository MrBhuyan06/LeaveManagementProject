...
public class RegistractionFacultyFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RegistractionFacultyFrame frame = new RegistractionFacultyFrame();
	 ...
	 * Create the frame.
	 */
	public RegistractionFacultyFrame() {
...
//				System.out.println(con);
				...
				lblNewLabel_1.setBounds(10, 0, 74, 75);
				...
				lblEnterId_3 = new JLabel("Enter Mentor Batch Id\r\n");
				lblEnterId_3.setFont(new Font("Arial", Font.BOLD, 21));
				lblEnterId_3.setBounds(31, 235, 269, 34);
				...
				lblEnterId_5.setBounds(31, 304, 155, 34);
...
//						String value= 
				...
				JComboBox<String> combomentorid = new JComboBox<String>();
				combomentorid.setModel(new DefaultComboBoxModel(new String[] {"Select Mentor Batch Id", "MCA-01", "B.Tech-02", "MBA-03"}));
				combomentorid.setFont(new Font("Arial", Font.BOLD, 16));
				combomentorid.setEditable(true);
				combomentorid.setBorder(UIManager.getBorder("CheckBoxMenuItem.border"));
				combomentorid.setBounds(377, 229, 269, 49);
				panel_2.add(combomentorid);
//				combod.setSelectedItem("Select Designation");
				...
				combog.setBounds(377, 298, 269, 49);
				panel_2.add(combog);
				...
				btnNewButton.setBounds(208, 447, 222, 41);
...
//				combog.setSelectedItem("Select ");
				...
				lblEnterUserId.setBounds(32, 30, 129, 34);
				...
				lblEnterId_2_1.setBounds(32, 102, 168, 34);
				...
				txtemail.setBounds(233, 26, 269, 45);
				...
				txtpass.setBounds(233, 93, 269, 45);
				...
				btnInsert.addMouseListener(new MouseAdapter() {
					@Override
					public void mouseClicked(MouseEvent e) {
						if(combocampus.getSelectedIndex()==0 ||combomentorid.getSelectedIndex()==0||combog.getSelectedIndex()==0 ) 
						{
...
//								JOptionPane.showMessageDialog(txtcaptcha, "");
								try {
								String q1,campus,batch,gender,psw;
								campus=(String)combocampus.getSelectedItem();
								batch=(String)combomentorid.getSelectedItem();
								
								gender=(String)combog.getSelectedItem();
								
								psw=String.valueOf(txtpass.getPassword());
								q1="insert into tbl_registrationfaculty values('"+txtid.getText()+"','"+txtname.getText()+"','"+campus+"','"+txtcontact.getText()+"','"+batch+"','"+gender+"','"+txtemail.getText()+"','"+psw+"')";
...
//								int r2=pspt.executeUpdate();
				...
				btnClearAll.addMouseListener(new MouseAdapter() {
					...
					public void mouseClicked(MouseEvent e) {
						...
						txtcontact.setText("");
						combomentorid.setSelectedIndex(0);
