...
public class ParticularStudentApprovalIFFuc extends JInternalFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ParticularStudentApprovalIFFuc frame = new ParticularStudentApprovalIFFuc();
	 ...
	 * Create the frame.
	 */
	public ParticularStudentApprovalIFFuc() {
		...
		javatable.setModel(new DefaultTableModel(
			new Object[][] {
				{new Integer(200), "Abhishek", null, null, "Fever", "Approved", "Approved"},
				{new Integer(202), "sarthak", null, null, "Family Function", "Approved", "Approved"},
				{new Integer(201), "subhangi", null, null, "Having Interview", "Approved", "Approved"},
				{new Integer(135), "subham", null, null, "Having a meeting", "Approved", "Approved"},
				{new Integer(119), "soumya", null, null, "marriage", "Waiting for approval", "Approved"},
				{new Integer(120), "Atul", null, null, "Having meeting", "Waiting for approval", "Approved"},
			},
			new String[] {
				"Sid", "Sname", "Dol", "Doa", "Reason", "RemarkWarden", "RemarkFaculty"
			}
		));
			...
			process.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent e) {
					...
					else 
					{
					 ...
					 try 
					 {
					  String q="update tbl_leaveapproval set RemarkFaculty=? where Sid=?";
			...
			panel_1.add(process);
			String x=SessionFaculty.Mentor_Id;
