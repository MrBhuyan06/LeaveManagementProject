...
public class FacultyZone extends JFrame {
	...
	private final JLabel lblNewLabel_6 = new JLabel("Welcome Faculty");
	ParticularStudentApprovalIFFuc objpa=new ParticularStudentApprovalIFFuc();
	AllLeaveRequestIFFac objla=new AllLeaveRequestIFFac();
	private final JLabel sessioname = new JLabel("");
	/**
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FacultyZone frame = new FacultyZone();
...
//				AllLeaveRequestIFFac obj=new AllLeaveRequestIFFac();
				DP.add(objla);
				objla.setVisible(true);
...
//				ParticularStudentApprovalIFFuc obj=new ParticularStudentApprovalIFFuc();
				DP.add(objpa);
				objpa.show();
			}
		});
...
//		            dispose();
		...
		lblNewLabel_3.setBounds(63, 231, 209, 168);
		...
		panel_1_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				int dialogButton = JOptionPane.showConfirmDialog (null, " Thank You For visiting Are you sure?","WARNING",JOptionPane.YES_NO_OPTION);
		...
		lblNewLabel_3_1.setBounds(79, 241, 193, 92);
		
		panel.add(lblNewLabel_3_1);
		lblNewLabel_6.setForeground(Color.WHITE);
		lblNewLabel_6.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_6.setBounds(10, 69, 353, 42);
		panel.add(lblNewLabel_6);
		lblNewLabel_6.setFont(new Font("Tahoma", Font.BOLD, 31));
		sessionid.setEnabled(false);
		sessionid.setHorizontalAlignment(SwingConstants.CENTER);
		sessionid.setBounds(10, 189, 353, 32);
//		int a=Session.id;
//		sessionid.setText(""+a);
		panel.add(sessionid);
		sessionid.setFont(new Font("Arial", Font.BOLD, 18));
		sessionid.setText("The Current userid id"+SessionFaculty.id);
		sessioname.setForeground(Color.WHITE);
		sessioname.setHorizontalAlignment(SwingConstants.CENTER);
		sessioname.setFont(new Font("Tahoma", Font.BOLD, 31));
		sessioname.setBounds(10, 137, 363, 42);
		sessioname.setText(SessionFaculty.name);
		panel.add(sessioname);
